...
- 3.2.1 CBOW 모델의 추론 처리
    ...
    - ![그림 [3-1]](https://user-images.githubusercontent.com/24144491/58879347-71cd0980-8710-11e9-9595-61e71df722f1.png){:width="70%" height="70%"}</left>

      

    - 그림 [3-2] : 가중치의 각 행이 해당 단어의 분산 표현이라고 볼 수 있다. 아래 그림과 결국 해당 단어와 곱해지는 원소들은 `W_in`에 동일한 행의 원소들이다.

      ![p3_2](https://user-images.githubusercontent.com/24144491/58879335-709bdc80-8710-11e9-9525-7924a8318ca8.png){:width="70%" height="70%"}</left>

      ![p3_2_1](https://user-images.githubusercontent.com/24144491/58879337-709bdc80-8710-11e9-9033-aab40700e97d.png){:width="70%" height="70%"}</left>
...
- 3.2.2 CBOW 모델의 학습
    ...
    - 그림 [3-3]
      ...
      ![p3_3](https://user-images.githubusercontent.com/24144491/58879338-709bdc80-8710-11e9-88a7-f8ab5f3497d3.png){:width="70%" height="70%"} </left>
...
- 3.5.2 skip-gram 모델
    ...
    - 그림 [3-5-2]
      ...
      ![p3_5_2](https://user-images.githubusercontent.com/24144491/58879340-709bdc80-8710-11e9-804f-ae06e35595be.png){:width="70%" height="70%"}</left>
